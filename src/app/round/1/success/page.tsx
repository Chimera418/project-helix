...
export default function Round1Success() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] w-full max-w-2xl mx-auto text-center gap-8">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold font-mono text-white mb-2">ACCESS GRANTED</h2>
        <p className="text-gray-400 uppercase tracking-widest text-sm mb-6">Round 1 Cleared</p>
        ...
        <div className="glass p-6 rounded-xl border-green-500/30 inline-block">
          ...
          <p className="text-2xl font-bold neon-text-green tracking-wider bg-black/50 py-3 px-6 rounded border border-green-500/10">KEY FRAGMENT 1</p>
        </div>
      </motion.div>
      ...
      >
        ...
        >
          Initialize Reverse Akinator <ArrowRight size={20} />
        </button>
      </motion.div>
    </div>
  );
